...
const (
	HelloGRPC_SayHi_FullMethodName          = "/pb.HelloGRPC/SayHi"
	HelloGRPC_GetAwesomeShow_FullMethodName = "/pb.HelloGRPC/GetAwesomeShow"
)
...
type HelloGRPCClient interface {
	...
	GetAwesomeShow(ctx context.Context, in *GetShowReq, opts ...grpc.CallOption) (*ShowRes, error)
}
...
func (c *helloGRPCClient) SayHi(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, HelloGRPC_SayHi_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloGRPCClient) GetAwesomeShow(ctx context.Context, in *GetShowReq, opts ...grpc.CallOption) (*ShowRes, error) {
	out := new(ShowRes)
	err := c.cc.Invoke(ctx, HelloGRPC_GetAwesomeShow_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloGRPCServer interface {
	...
	GetAwesomeShow(context.Context, *GetShowReq) (*ShowRes, error)
...
func (UnimplementedHelloGRPCServer) GetAwesomeShow(context.Context, *GetShowReq) (*ShowRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAwesomeShow not implemented")
}
...
func _HelloGRPC_GetAwesomeShow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetShowReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloGRPCServer).GetAwesomeShow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelloGRPC_GetAwesomeShow_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloGRPCServer).GetAwesomeShow(ctx, req.(*GetShowReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HelloGRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAwesomeShow",
			Handler:    _HelloGRPC_GetAwesomeShow_Handler,
		},
	},
